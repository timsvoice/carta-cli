...
2. Verify `.specimen/plans/{branch}/` exists. If not: `Error: specimen not initialized. Run /init first.`
3. Read `.specimen/plans/{branch}/plan.md` (high-level plan)
4. Read `.specimen/plans/{branch}/spec.md` (feature specification)
...
2. Save to `.specimen/plans/{branch}/implementation.md`
3. Confirm: `Implementation tasks saved to .specimen/plans/{branch}/implementation.md`
...
```bash
mkdir -p .specimen/plans/{branch}/tasks/
```

## Step 2: Parse Implementation.md

1. Read `.specimen/plans/{branch}/implementation.md`
...
**File**: `.specimen/plans/{branch}/tasks/phase_1.md`
**Content**:
```markdown
# Phase N: {Phase Name}
...
Save to `.specimen/plans/{branch}/tasks/manifest.json`
...
✓ Generated {N} phase files and manifest with {M} tasks
  - Phase files: .specimen/plans/{branch}/tasks/phase_1.md through phase_{N}.md
  - Manifest: .specimen/plans/{branch}/tasks/manifest.json
```

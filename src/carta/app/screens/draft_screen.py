...
class DraftScreen(Screen[DraftResult], AgentScreenMixin):
    ...
    def __init__(self, feature_description: str, answers: list[dict]) -> None:
        ...
        self._saved_feature_path: str | None = None
    ...
    def handle_input(self, value: str) -> None:
            ...
            if value_lower in ("new", "restart", "again"):
                ...
                self.dismiss(
                    DraftResult(
                        ...
                        feature_path=self._saved_feature_path,
                    )
                )
            else:
        ...
        # Exit without saving
            ...
            self.dismiss(DraftResult(status="done", prompt_for_plan=False))
    ...
    def _save_draft(self) -> None:
        ...
        # Store the path for the plan prompt
        self._saved_feature_path = str(feature_dir)
